...
//         { id: '3',imageName: 'https://i.ibb.co/9rqwvsz/3.jpg', tag: 'Guru Banquet'},
//         { id: '4',imageName: 'https://i.ibb.co/8XQgYpz/4.jpg', tag: 'Guru Banquet'},
//         { id: '5',imageName: 'https://i.ibb.co/WnrfmZs/5.jpg', tag: 'Guru Banquet'},
//         { id: '6',imageName: 'https://i.ibb.co/4RLGhdk/6.jpg', tag: ''},
//         { id: '7',imageName: 'https://i.ibb.co/qWvDQTf/7.jpg', tag: ''},
//         { id: '8',imageName: 'https://i.ibb.co/zRjjKxW/8.jpg', tag: 'Table '},
//         { id: '9',imageName: 'https://i.ibb.co/4gqxGNL/9.jpg', tag: 'Table '},
//         { id: '10',imageName: 'https://i.ibb.co/MPbpJhg/10.jpg', tag: ''},
...
//         { id: '85',imageName: 'https://i.ibb.co/gPzxT17/16.jpg', tag: 'Table '}
//     ]
...
//              {records.map((e,i )=>( 
//               <div key={e.id}className={i === active ? "active" : ""}onClick={ () => handleClick(i)} >
...
//       {
//         numbers.map((n, i) =>
//           <button id='gallery-bag' className={n==actives?"active-btn":""} onClick={()=>handleClickp(n)}><span className='cgallery-span1'><span className="cgallery-span2">{n}</span></span></button>
//         )
//       }
...
//   );
// };
// const Slides = ({imageName,tag,active, id}) =>{
//   return(
//     <div className="image-slide"> 
//       <img src={imageName} alt={tag}className={active ? "active" : ""}  />
//     </div>
//   );
// };
